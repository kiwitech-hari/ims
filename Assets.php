						...
						<div class="col-md-12">
							<div class="tabs tabs-primary">
								...
								<div class="tab-content">
									...
									<?php
									} // if isset id=xxx in url
									  ?>

									<?php if (isset($_GET['Asset_Details'])) {
										# code...

									
									 $Aset_SN=$_GET['Asset_Details'];
									 ...
									 <?php  
										...
										$query = mysqli_query($conn,"SELECT * FROM `it_assets` WHERE `serial_no`='$Aset_SN'");
										$row=mysqli_fetch_array($query);
										$asset=$row['category'];
										$brand=$row['brand'];
										$modal=$row['model_no'];
										...
										$sqlq=mysqli_query($conn,"UPDATE `it_assets` SET other_info='$notes' WHERE `serial_no`='$serial'");
										if ($sqlq) {
											$alart="info";
											$type= "Successful!!";
										...
										<div class="col-xs-12">
											<section class="panel">
												<header class="panel-heading">
													...
													<h2 class="panel-title">View/Update Asset Details - <?php echo "$serial";  ?></h2>
												</header>
												<div class="panel-body">
													<form action="" method="POST">
														...
														<div class="alert alert-dark">
															...
															<strong>Assets Full Details :: </strong>  Ready to Update all information about this  <a href="" class="alert-link"><?php echo "$asset";  ?> <?php echo "$brand";  ?>(<?php echo "$serial";  ?>)</a>.
														</div>
														<div class="form-group">
															...
															<div class="form-group">
																<label class="col-md-2 control-label">Modal No</label>
																<div class="col-md-4">
																	<input type="text" name="modal" value="<?php echo "$modal";  ?>" class="form-control" readonly>
																</div>
																<label class="col-md-2 control-label" for="inputTooltip">Purchased Date</label>
																<div class="col-md-4">
																	<input type="text" name="issued" value="<?php echo "$pdate";  ?>" class="form-control"  readonly>
																</div>
															</div>
														<!-- 	<div class="form-group">
																<label class="col-md-2 control-label">Modal No</label>
															...
															<div class="form-group">
																<label class="col-sm-2 control-label">Asset Configration</label>
																<div class="col-sm-10">
																	<textarea name="notes" rows="8" class="form-control"><?php echo "$remark";  ?></textarea>
																</div>
															</div>
										...
										<div class="col-xs-12">
											<section class="panel">
												<header class="panel-heading">
													...
													<h2 class="panel-title">Asset Tracking System (ATS) - <?php echo "$serial";  ?></h2>
												</header>
												<div class="panel-body">
													<table class="table table-bordered table-striped mb-none" id="datatable-default">
														...
														<tbody>
															...
															$sql = "SELECT * FROM `asigned_assets` WHERE `serial_no`='$Aset_SN'";
															//echo "$sql";
															$query=mysqli_query($conn,$sql);
															while ($row=mysqli_fetch_array($query)) {
												               ...
												               echo "<td> <a href=uassets.php?uid=".$row['userid'].">".$row['fullname'] ."(" .$row['userid'].")</a></td>";
									...
									<div class="row">
										<div class="col-xs-12">
											<section class="panel">
												<header class="panel-heading">
													...
													<h2 class="panel-title">Troubleshooting - <?php echo "$serial";  ?></h2>
												</header>
												<div class="panel-body">
													<table class="table table-bordered table-striped mb-none" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
														...
														<tbody>
															...
															$sql = "SELECT * FROM `itsupport` WHERE `sysid` LIKE '%$Aset_SN%'";
															//echo "$sql";
															$query=mysqli_query($conn,$sql);
															while ($row=mysqli_fetch_array($query)) {
									 ...
									 <?php  } // Asssets details view an updatation. if ISSET[Asset_Details] ?>
