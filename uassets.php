						...
						<div class="col-md-12">
							<div class="tabs tabs-primary">
								<ul class="nav nav-tabs">
									...
									<li>
										<a href="userlist.php"><i class="fa fa-users"></i> Users List</a>
									</li>
												...
												<section class="panel">
													<div class="panel-body">
														<div class="thumb-info mb-md">
															<img src=<?php echo $profilePic; ?> class="rounded img-responsive" alt="John Doe">
										...
										<section class="panel">
											<!--<form action="" method="POST">-->
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<textarea id="remark" rows="5" class="form-control" placeholder="Describe about This Assets"></textarea>
													</div>
												</div>
