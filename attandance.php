...
<html class="scroll sidebar-left-collapsed">
	...
	<head>
		...
		<title>Attandance Management System | AMS</title>
				...
				<section role="main" class="content-body">
					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="tabs tabs-primary">
								<ul class="nav nav-tabs">
									<li class="active">
										<a href="#tab1" data-toggle="tab"><i class="fa fa-user"></i> Attandance</a>
									</li>
									<li>
										<a href="#tab2" data-toggle="tab"><i class="fa fa-book"></i> Mark Attandance</a>
									</li>
						...
						<div id="tab2" class="tab-pane">
							...
							<button type="button" class="mb-xs mt-xs mr-xs btn btn-primary"><i class="fa fa-mark"></i> Check in</button>
